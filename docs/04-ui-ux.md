...
- **Flop** (card do app): o rosto do cachorro no lugar do avatar, "E o narga?" como autor, "📉 O post de Fulano flopou 200%" e, embaixo, uma prévia do post que flopou (miniatura ou 🎬/🎤/💬, nome e começo do texto, ou "mandou um vídeo") linkando pra âncora dele no feed. Sem a linha "de onde". Reações e comentários iguais aos de qualquer post; menu "⋯" pra quem postou o original e pro admin. Reação nele vira a linha "Fulano reagiu 😂 no flop de Ciclano".
...
- **Comentário com foto ou áudio**: a foto entra abaixo do texto (ou sozinha), com no máximo 256 px de largura e 320 px de altura, cantos arredondados, e abre em tela cheia ao tocar; o áudio usa o mesmo player de mensagem de voz do post, na largura do comentário. Na caixa de comentar, à direita de "Enviar" e "Cancelar", dois botões redondos: 📷 ("Anexar foto", abre câmera ou galeria) e 🎤 ("Gravar áudio", o mesmo gravador do post, ali mesmo na thread). A prévia aparece entre o texto e os botões com um "×" pra tirar; "Enviar" habilita com texto ou anexo. Enquanto grava, "Enviar" e os dois botões ficam desabilitados.
