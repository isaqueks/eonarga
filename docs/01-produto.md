...
- **Cutucar** (na Galera): cada pessoa tem um botão que manda um push só pra ela, "Fulano cutucou você", que **vibra o celular** e abre a galera. Uma cutucada por minuto por quem cutuca, seja lá o alvo; se a pessoa não ligou notificação, o botão avisa.
- A notificação chega com a **foto de quem agiu** (comentou, curtiu, mencionou, chamou a galera, cutucou) como ícone e um narguilé branco como badge na barra de status. Sem foto, ou num aviso do admin, aparece o rosto do cachorro. iPhone ignora isso e mostra o ícone do app.
