...
- Comentário tem **curtir**: um coração com a contagem do lado, sem os emojis das reações, tanto em post quanto em resposta de avaliação. Uma curtida por pessoa, todo mundo vê quantas; curtir não apita ninguém. Embaixo de cada comentário ficam "Responder" e "Apagar", lado a lado.
